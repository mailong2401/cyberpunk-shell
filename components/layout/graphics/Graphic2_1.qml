...
Shape {
  ...
  ShapePath {
    ...
    PathLine { x: width * 0.025; y: height }
    PathLine { x: width * 0.075; y: height }
    PathLine { x: width * 0.075; y: height * 0.85 }
    PathLine { x: width * 0.06; y: height * 0.82 }
    PathLine { x: width * 0.06; y: height * 0.2 }
    PathLine { x: width * 0.075; y: height * 0.17 }
    PathLine { x: width * 0.075; y: 0 }
    PathLine { x: width * 0.04; y: 0 }
  ...
  ShapePath {
    ...
    startX: width * 0.1; startY: height * 0.05
    ...
    PathLine{x: width * 0.1;y: height }
    PathLine{x: width * 0.1;y: height * 0.05 }
  }
